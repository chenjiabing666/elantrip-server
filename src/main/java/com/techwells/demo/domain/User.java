...
public class User {
	...
	public String toString() {
		return "User [userId=" + userId + ", userName=" + userName
				...
				+ ", userIcon=" + userIcon + ", gender=" + gender
				+ ", address=" + address + ", provinceCode=" + provinceCode
				+ ", isDeveloper=" + isDeveloper + ", realName=" + realName
				+ ", roleId=" + roleId + ", activated=" + activated
				+ ", deleted=" + deleted + ", lastLoginTime=" + lastLoginTime
				+ ", enterpriseName=" + enterpriseName + ", publisherName="
				+ publisherName + ", idCardImage=" + idCardImage
				+ ", businessLicense=" + businessLicense
				+ ", businessLicenseNumber=" + businessLicenseNumber
				+ ", registedAddress=" + registedAddress + ", contactName="
				+ contactName + ", contactMobile=" + contactMobile
				+ ", contactAddress=" + contactAddress + ", email=" + email
				+ ", qq=" + qq + ", webAddress=" + webAddress
				+ ", examinStatus=" + examinStatus + ", createDate="
