package com.yilan.elantrip.util;
...
public class SendSmsUtil {
	 ...
	 * @throws Exception
	 */
	public static void sendUserCrCode(String mobile, String crCode) throws Exception {
	 ...
	 * @param crCode
	 */
	public static void sendUserNameAndPassword(String mobile, String username, String password) {
	 ...
	 * @param crCode
	 */
	public static void sendUserNameAndPassword(String mobiles, String messageContent) {
